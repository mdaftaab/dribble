        ...
        <div className="footer-main-content">
          <div>
            <a href="#">
              <svg
                viewBox="0 0 96 24"
                role="img"
                aria-labelledby="a3n13jr7o8mj743x2w2y3ghwd3zamuj0"
                className="icon dribbble-wordmark"
              >
                <title id="a3n13jr7o8mj743x2w2y3ghwd3zamuj0">
          ...
          <div className="links-container">
            <div className="links-column">
              ...
              <Link href="/">
                <a className="link">Go Pro!</a>
              </Link>
              <Link href="/">
                <a className="link">Explore design work</a>
              </Link>
              <Link href="/">
                <a className="link">Design blog</a>
              </Link>
              <Link href="/">
                <a className="link">Overtime podcast</a>
              </Link>
              <Link href="/">
                <a className="link">Playoffs</a>
              </Link>
              <Link href="/">
                <a className="link">Weekly Warm-Up</a>
              </Link>
              <Link href="/">
            ...
            <div className="links-column">
              ...
              <a rel="noopener" className="link" href="#">
                Freelancing
              </a>
              <a rel="noopener" className="link" href="#">
                Design Hiring
